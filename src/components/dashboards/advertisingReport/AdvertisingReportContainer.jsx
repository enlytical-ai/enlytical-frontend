...
const AdvertisingReportContainer = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .post(
        `${BASE_URL}dashboard/advertisingReport/getTileData?brandId=${current_brand}`,
        {
    ...
    axios
      .post(
        `${BASE_URL}dashboard/advertisingReport/getCategoryTableData?brandId=${current_brand}`,
        {
          time_stamp: "2022-11-20T00:00:00.000+00:00",
          campaign_type_array,
          category_array: [
    ...
    axios
      .post(
        `${BASE_URL}dashboard/advertisingReport/getTargetsTableData?brandId=${current_brand}`,
        {
  ...
  const graphAreaSelectFn = (e) => {
    ...
    if (startDateArray.length === 2 && endDateArray.length === 2) {
      ...
      axios
        .post(
          `${BASE_URL}dashboard/advertisingReport/getCategoryAndASINOfTwoRange?brandId=${current_brand}`,
          {
            time_range_one: {
  ...
  return (
    <div className="advertisingReportContainer">
      ...
      <div className="advertisingReportContainerRow_3">
        {state.tile_array.length ? (
          state.tile_array.map((tile) => {
            let obj;
      ...
      <div className="advertisingReportContainerRow_5">
        {lineGraphErrorToggle && (
          <div className="lineGraphComponentError">
            <p>You cannot select more than two data sets.</p>
          </div>
        )}
        {loader.graphLoader && (
          <div
      ...
      <div
        id="advertisingReportContainerRow_6"
        className="advertisingReportContainerRow_6"
      >
        ...
        <CategoryAndASINOfTwoRangeTableComponent
          category_and_ASIN_of_two_range={state.category_and_ASIN_of_two_range}
        />
      </div>
